...
class principal{
    ...
    public static void main(String[] args) {
        ...
        fichas[1][0]=new Torre(0,7,1);fichas[1][1]=new Caballo(1,7,1);fichas[1][2]=new Elefante(2,7,1);fichas[1][3]=new Visir(3,7,1);
        fichas[1][4]=new Rey(4,7,1);fichas[1][5]=new Elefante(5,7,1);fichas[1][6]=new Caballo(6,7,1);fichas[1][7]=new Torre(7,7,1);
                ...
                do{
                    ...
                    if(general.validarFC(fmov,cmov)){
                        for(int i=0; i<fichas.length;i++){
                            for(int e=0;e<fichas[i].length;e++){
                                if(fichas[i][e].columna==cmov && fichas[i][e].fila==fmov && fichas[i][e].bando==turno){
